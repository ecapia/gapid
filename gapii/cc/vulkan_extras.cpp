...
void VulkanSpy::mapMemory(CallObserver*, VkDeviceMemory, void**, gapil::Slice<uint8_t>) {}
void VulkanSpy::unmapMemory(CallObserver*, VkDeviceMemory, gapil::Slice<uint8_t>) {}
